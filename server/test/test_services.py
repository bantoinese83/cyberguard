...
class TestWebsiteStatistics(unittest.TestCase):
    ...
    def test_website_statistics_no_api_key(self, mock_get):
        ...
        # Assert the expected result
        self.assertEqual(result, {"error": "SIMILARWEB_API_KEY not found in environment variables."})
    ...
    def test_website_statistics_http_error(self, mock_get):
        ...
        # Assert the expected result
        self.assertEqual(result, {"error": "Domain 'example.com' not found or does not have a global rank."})
    ...
    def test_website_statistics_request_exception(self, mock_get):
        ...
        # Assert the expected result
        self.assertEqual(result, {"error": "Error fetching website statistics: Request failed"})
